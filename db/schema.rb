...
ActiveRecord::Schema[7.1].define(version: 2024_07_14_114660) do
  ...
  create_table "characters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["affiliation_id"], name: "index_characters_on_affiliation_id"
  end

  create_table "episode_relations", force: :cascade do |t|
  ...
  create_table "nen_abilities", force: :cascade do |t|
    t.string "aura_type"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "nen_ability_relations", force: :cascade do |t|
    t.integer "character_id", null: false
    t.integer "nen_ability_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "characters", "affiliations"
